...
// class NewUploads extends StatelessWidget {
//   @override
...
class _NewUploadsState extends State<NewUploads> {
  ...
  void getlist() async {
    ...
    for (var i in tempio.reversed.toList()) {
      print(i);
    ...
    setState(() {
      if (list.length != videolist.length) videolist = list1.length>4?list1.sublist(0, 4):list1;
      flag = true;
    });
  }
